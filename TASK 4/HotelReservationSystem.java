...
public class HotelReservationSystem {
    ...
    public static void main(String[] args) {
        // Create the main frame (Fullscreen)
        ...
        ImageIcon originalImage = new ImageIcon("src/images/hotel_image.png"); // Adjust the path
        Image scaledImage = originalImage.getImage().getScaledInstance(
                Toolkit.getDefaultToolkit().getScreenSize().width,
                Toolkit.getDefaultToolkit().getScreenSize().height,
                Image.SCALE_SMOOTH); // Fullscreen background
        ...
        // Add the 'Hotel Reservation' menu
        JMenu reservationMenu = new JMenu("Hotel Reservation");
        JMenuItem reception = new JMenuItem("Reception");
        reception.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // Show frame for reservation
                new HotelDashboard().setVisible(true); // Instantiate and display the login form
            }
        });
        reservationMenu.add(reception);
        menuBar.add(reservationMenu);

        // Add the 'Login for Admin' menu and a new action listener to show the login form
        JMenu adminMenu = new JMenu("Login");
        JMenuItem adminLogin = new JMenuItem("Admin Panel");
        adminLogin.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // Show login form for admin
                new AdminLoginForm().setVisible(true); // Instantiate and display the login form
            }
        });
    ...
    static class AdminLoginForm extends JFrame {
        ...
        public AdminLoginForm() {
            // Set properties for the login form window
